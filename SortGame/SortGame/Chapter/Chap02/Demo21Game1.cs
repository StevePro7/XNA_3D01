...
namespace MyGame
{
	public class Demo21Game1 : MyBaseGame
	{
		...
		protected override void LoadContent()
		{
			...
			var model = Content.Load<Model>("Content/teapot__cv1");
			var ground = Content.Load<Model>("Content/ground");
			models.Add(new CModel(model, new Vector3(0, 60, 0), Vector3.Zero, new Vector3(60), GraphicsDevice));
		...
		private void updateCamera(GameTime gameTime)
		{
			...
			// Rotate the camera
			//((FreeCamera)camera).Rotate(deltaX * 0.005f, deltaY * 0.005f);
